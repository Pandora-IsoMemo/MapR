...
- option to download all user inputs together with the content of the
  zip files of all imported figures (#29)

## MapR 24.3.0

### Updates

- applying exportData module from shinyTools package, removing the code
  from this package
...
- apply most recent DataTools version to fix the broken path to the
  example zip files
...
- user can fill out questionnaires and images are displayed depending on
  the answers
...
- option to upload zip files via the import module from `DataTools`.
  Enables access to files from URL, Pandora Platform, local files, and
  online examples
